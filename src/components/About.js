                        ...
                        <div className="content block text-secondary text-left">
                            ...
                            <div className="header-container overflow-hidden mb-[2vh] pt-[5%]">
                                ...
                                <p>
                                    ...
                                    <div className="mb-2 text-justify"> Back in 2012, my journey into coding began when my brother introduced me to the world of programming during my school days—a world that instantly captivated me. Fast-forward to today, I have had the opportunity to build applications for both large corporations and startups.</div>
                                    <div className="mb-2 text-justify">In this ever-evolving landscape of technology, I've learned that success isn't just about technical proficiency—it's about passion, creativity, and a relentless pursuit of excellence. With every line of code, every late-night debugging session, I'm driven by a sense of purpose and a desire to push the boundaries of what's possible.</div>
                                    <div className="mb-2 text-justify">As I continue to write the next chapters of my story, I'm reminded of the countless opportunities and challenges that lie ahead. But amidst the uncertainty, one thing remains clear: I am a problem solver, a creative thinker, and a versatile technophile. And with each new project, I'm committed to leaving my mark on the world, one line of code at a time.</div>
                                    <div className="mb-2 text-justify">When I’m not at the computer, you'll often find me exploring new destinations, experimenting in the kitchen, immersing myself in a good book, or enjoying a captivating movie.</div>
